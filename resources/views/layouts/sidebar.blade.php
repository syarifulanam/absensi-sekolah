<div id="sidebar" class="bg-dark text-white d-flex flex-column p-3 sidebar"
    ...
    <div class="text-center mb-4">
        ...
        <h4 class="fw-bold mb-0">ABSENSI</h4>
        <small class="text-secondary">Sistem Sekolah</small>
    </div>
    ...
    <ul class="nav nav-pills flex-column gap-1">
        ...
        <li class="nav-item">
            <a href="{{ url('/absensi/scan') }}"
                ...
                <span class="ms-2">Scan Absensi</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a href="{{ url('/absensi/scan-camera') }}"
                ...
                <span class="ms-2">Scan QR Kamera</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a href="{{ url('/absensi') }}"
                ...
                <span class="ms-2">Kelola Absen</span>
            </a>
        </li>
